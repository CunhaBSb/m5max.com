        ...
        <div className="py-8 text-center">
          ...
          <div className="flex flex-col gap-2 items-center">
            ...
            <Button
              ...
              className="w-full max-w-xs h-11 font-semibold text-sm border-fire-orange/60 bg-gradient-to-r from-fire-orange/15 via-fire-gold/10 to-fire-orange/15 shadow-[0_12px_28px_-16px_rgba(249,115,22,0.85)] hover:scale-[1.01] transition-all"
            ...
            <div className="w-full max-w-xs rounded-xl border border-fire-orange/30 bg-gradient-to-r from-fire-orange/10 via-fire-gold/5 to-fire-orange/10 px-3 py-2">
              <div className="flex items-center justify-between text-[10px] uppercase tracking-[0.12em] text-fire-gold/85 font-semibold">
