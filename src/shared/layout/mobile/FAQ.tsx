...
export const FAQMobile = ({ 
  ...
  return (
    <section className="relative py-8 xs:py-12 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 max-w-3xl">
        <div className="text-center mb-6 xs:mb-8">
          ...
          <h2 className="text-lg xs:text-xl font-bold mb-3 xs:mb-4">
            <span className="text-foreground">{title.split(' ').slice(0, -1).join(' ')}</span>
            <br className="xs:hidden" />
            <span className="xs:ml-2 text-fire-gradient">{title.split(' ').pop()}</span>
          </h2>
          ...
          <div className="bg-gradient-to-r from-fire-orange/5 to-fire-gold/5 p-3 xs:p-4 rounded-xl border border-fire-orange/15 text-center">
            ...
            <div className="flex gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="w-full h-9 bg-gradient-to-r from-green-600/20 via-green-500/30 to-green-600/20 border border-green-500/50 text-white hover:from-green-500/30 backdrop-blur-sm"
