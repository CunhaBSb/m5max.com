...
const ShowcaseVideoCard = ({ youtubeId, title, description, badges, features }: ShowcaseVideoCardProps) => {
  ...
  return (
    <div className="relative group animate-fade-in-up h-full" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
      ...
      <div className="absolute -inset-0.5 sm:-inset-1 bg-gradient-to-r from-fire-orange/20 via-fire-gold/30 to-fire-orange/20 rounded-lg sm:rounded-xl blur-sm sm:blur-lg opacity-60 group-hover:opacity-100 transition-opacity duration-500" />
      
      <Card className="relative h-full flex flex-col bg-gradient-to-br from-black/60 via-gray-900/40 to-black/60 backdrop-blur-sm border border-fire-orange/30 overflow-hidden shadow-lg sm:shadow-2xl shadow-fire-orange/10 group-hover:shadow-fire-orange/20 transition-all duration-300">
        {/* Video Player */}
        <div className="aspect-video relative overflow-hidden">
          ...
          {/* Overlay com badges */}
          <div className="absolute top-2 left-2 sm:top-3 sm:left-3 flex flex-wrap gap-1 sm:gap-2 max-w-[calc(100%-4rem)] sm:max-w-[calc(100%-6rem)] pointer-events-none z-10">
            {badges.map(badge => (
              <Badge key={badge} className="bg-fire-orange/90 hover:bg-fire-orange text-white text-xs sm:text-xs font-medium shadow-lg backdrop-blur-sm px-1.5 py-0.5 sm:px-2 sm:py-1">
                {badge}
              </Badge>
            ))}
          </div>
        ...
        <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4 flex-1 flex flex-col">
          <div className="flex-1">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 group-hover:text-fire-orange transition-colors">
              {title}
            </h3>
          ...
          {/* Features */}
          <div className="flex flex-wrap gap-2 text-xs mt-auto pt-2 sm:pt-3 border-t border-white/10">
  ...
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-1/4 left-1/6 w-1.5 h-1.5 lg:w-2 lg:h-2 bg-fire-orange/40 rounded-full animate-pulse" style={{ animationDelay: '0s' }} />
        <div className="absolute top-1/3 right-1/5 w-1 h-1 lg:w-1.5 lg:h-1.5 bg-fire-gold/50 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-1/3 left-1/3 w-1.5 h-1.5 lg:w-2 lg:h-2 bg-fire-orange/30 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-1/4 right-1/3 w-1 h-1 lg:w-1.5 lg:h-1.5 bg-fire-gold/40 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="relative container mx-auto px-4 sm:px-6 max-w-6xl">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <div className="flex items-center justify-center gap-2 xs:gap-3 mb-3 xs:mb-4">
            ...
            {/* Mobile Stats Badge */}
            <div className="lg:hidden flex items-center gap-1 bg-white/10 backdrop-blur-sm px-2 py-1 rounded-full border border-fire-gold/30">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            <h2 className="text-xl xs:text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 xs:mb-3 sm:mb-4 leading-tight">
              <span className="text-white">Cada show conta uma</span>
              <br />
              <span className="text-fire-gradient">História única.</span>
            </h2>
            
            <p className="text-sm xs:text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed px-2 xs:px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 lg:mb-20 items-stretch">
        ...
        <div className="animate-fade-in-up" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
          {/* Mobile CTA */}
          <div className="sm:hidden bg-gradient-to-r from-fire-orange/5 to-fire-gold/5 backdrop-blur-sm border border-fire-orange/15 rounded-xl p-4 text-center mb-6">
          ...
          {/* Desktop CTA */}
          <div className="hidden sm:block bg-gradient-to-r from-black/40 via-black/60 to-black/40 backdrop-blur-sm border border-white/10 rounded-lg p-6 text-center">
