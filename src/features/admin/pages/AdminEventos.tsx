          ...
          <div className="flex justify-center w-full">
            <div className="w-full max-w-5xl flex flex-col items-center gap-5 bg-white/[0.01] border border-white/5 p-4 sm:p-8 rounded-[28px] sm:rounded-[40px] shadow-2xl backdrop-blur-md">
              <div className="admin-page-intro text-center space-y-2">
                ...
                <p className="admin-page-subtitle text-xs uppercase tracking-[0.3em] text-muted-foreground/30">
              ...
              <div className="flex flex-col lg:flex-row items-stretch gap-2">
                ...
                <div className="flex-[1.5] bg-white/[0.02] rounded-[24px] sm:rounded-[32px] p-4 sm:p-6 flex flex-col items-center justify-center border border-white/5">
                  ...
                  <div className="relative w-full group">
                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/10 group-focus-within:text-primary transition-colors" />
                    <Input
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          statusFilter === s
                            ...
                            : "bg-white/[0.03] border-white/[0.08] text-muted-foreground/30 hover:bg-white/5"
                        )}
                      >
                        {s === 'all' ? 'Todos' : s}
                      </button>
          ...
          <div className="relative">
            {filteredEventos.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-40 border border-white/[0.04] bg-white/[0.01] rounded-[3rem]">
                <Calendar className="h-16 w-16 text-muted-foreground/10 mb-6" />
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-3 mb-4">
                              <Badge className={cn(
                                ...
                                isRealizado ? "bg-emerald-500/10 text-success border-emerald-500/20" : isPendente ? "bg-white/5 text-white/40 border-white/10" : "bg-primary/10 text-primary border-primary/20"
                              )}>
      ...
      <Dialog open={isDetailsOpen} onOpenChange={setIsDetailsOpen}>
        <DialogContent className="sm:max-w-2xl p-0 overflow-hidden">
          <div className="flex max-h-[85vh] flex-col">
                        ...
                        {selectedEvento.orcamentos.orcamentos_produtos.map((item, idx) => (
                          ...
                          >
                            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                              <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-lg bg-white/[0.05] text-sm font-bold text-muted-foreground">
                                {item.quantidade}x
                              </div>
                              <div className="flex flex-col">
                                ...
                                <p className="text-[10px] font-mono text-muted-foreground/30 uppercase mt-0.5">
            ...
            <div className="sticky bottom-0 z-20 border-t border-white/[0.06] bg-card/95 px-6 py-4 sm:px-8 backdrop-blur-xl rounded-b-[24px] sm:rounded-b-[32px] flex justify-end">
              <Button
                variant="ghost"
