...
const AdminStart = () => {
  ...
  return (
    <div
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-card px-4 py-10 sm:px-6"
      style={{
    ...
    >
      ...
      <main className="relative z-10 w-full max-w-md rounded-[32px] border border-white/10 bg-charcoal-900/40 p-6 shadow-[0_30px_100px_rgba(0,0,0,0.75)] backdrop-blur-2xl sm:p-8">
