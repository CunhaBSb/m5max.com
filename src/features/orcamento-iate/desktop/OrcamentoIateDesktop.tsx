    ...
    <>
      ...
      <RootLayout>
        <main className="min-h-screen bg-background">
          {/* HERO */}
          <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden pt-20 md:pt-20 pb-12">
            <div className="absolute inset-0 z-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-background/75 via-background/55 to-transparent" />
                  ...
                  <div className="flex flex-col gap-3 w-full max-w-3xl">
                    ...
                    >
                      ...
                      <div className="flex flex-col text-left">
                        ...
                        <span className="text-xs text-yellow-200/80">7 min + 1 min brinde</span>
                      </div>
                    </Button>
                ...
                <Card className="bg-gradient-to-br from-white/8 via-white/5 to-white/3 border border-white/10 shadow-elegant h-full">
                  <CardContent className="p-5 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Button variant="outline-fire" onClick={openPdf}>
                        <DownloadCloud className="w-4 h-4 mr-2" /> Baixar orçamento (PDF)
                      </Button>
                    </div>
                  </CardContent>
                </Card>
        ...
        <Dialog open={pdfOpen} onOpenChange={setPdfOpen}>
          <DialogContent className="max-w-[1200px] w-[100vw] h-[100vh] p-0 overflow-hidden">
            <DialogHeader className="px-6 pt-4 pb-2">
              <DialogTitle className="text-lg font-semibold">Orçamento Iate Clube de Brasília — Réveillon 2026</DialogTitle>
            </DialogHeader>
