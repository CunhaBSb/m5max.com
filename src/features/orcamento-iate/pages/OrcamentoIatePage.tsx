...
import { Calendar, MapPin, Shield, DownloadCloud, MessageSquare, Sparkles, CheckCircle2, Clock3, FileCheck, Zap, Play, Award } from 'lucide-react';
import { heroContent as homeHeroContent } from '@/features/home/data/homeContent';

const VIDEO_ID = 'lGfy9082X7w';

const OrcamentoIatePage = () => {
  const { trackPageView, trackWhatsAppClick } = useAnalytics();
  const { attribution } = useAppStore();
  const [videoLoaded, setVideoLoaded] = useState(false);
  const showSecondaryButtons = true; // CTAs visíveis imediatamente
      ...
      <RootLayout>
        <main className="min-h-screen bg-background">
          ...
          <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden pt-24 md:pt-24 pb-14">
            {/* Video Background (copiado do hero da home) */}
            ...
            {/* Bottom vignette from home hero */}
            ...
            <div className="relative z-30 container mx-auto px-8">
              <div className="flex justify-start min-h-[80vh]">
                {/* Layout copiado da home (sem vídeo ao lado) */}
                  ...
                  <div className="flex flex-col gap-4 w-full max-w-md">
                    <div className="animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
                      ...
                      >
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-yellow-200/80">Não listada • 90s</span>
                        </div>
                      </Button>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-sm font-medium">PDF em finalização</span>
                      </Button>
                    </div>
                  </div>

                  {/* Badges de confiança iguais à home */}
                  <div className="flex items-center justify-start gap-2 flex-wrap">
                  ...
                  <CardContent className="p-5 space-y-4 text-sm text-white/85 leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 gap-2 text-white/80">
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <span>Confirmação de janela e sequência de 8 minutos (7 + 1 brinde)</span>
                      </div>
                      <div className="flex items-start gap-2">
                ...
                <Card className="bg-gradient-to-br from-white/8 via-white/5 to-white/3 border border-white/10 shadow-elegant h-full">
                  <CardContent className="p-5 space-y-4">
                    ...
                    <p className="text-white/80 text-sm leading-relaxed">
                      Atualizações finais e entrega do PDF após validação jurídica. Podemos antecipar ajustes via canal direto.
                    </p>
                    <div className="flex flex-wrap gap-3">
                      ...
                      <Button
                        ...
                        disabled
                      >
                        <DownloadCloud className="w-4 h-4 mr-2" /> PDF (liberação jurídica)
                      </Button>
                    </div>
                  </CardContent>
                </Card>
          ...
          <section className="container mx-auto px-6 max-w-4xl pb-16">
            <div className="bg-gradient-to-br from-white/8 via-white/6 to-white/3 border border-white/10 rounded-xl p-6 space-y-4 shadow-elegant">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs px-2 py-1 rounded-full bg-amber-500/15 border border-amber-400/40 text-amber-100">Em aprovação jurídica</span>
              </div>
              <p className="text-white/80 text-sm leading-relaxed">
                PDF (custos, cronograma, memorial e exigências locais) em revisão final. Assim que liberado, ativaremos o download nesta página e enviaremos ao contato autorizado do clube.
              </p>
              <div className="flex gap-3 flex-wrap">
                <Button disabled variant="outline-fire">
                  PDF em finalização
                </Button>
                <Button
                  variant="ghost"
