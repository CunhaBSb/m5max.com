...
const SaoJoaoHero = () => {
  ...
  const handleWhatsAppClick = useCallback(() => {
    ...
    const url = generateWhatsAppURL(
      message,
      attribution?.utm,
      { audience: 'general', source: 'sao_joao_hero_mobile' }
    );

    trackWhatsAppClick({
      audience: 'b2b',
      source: 'sao_joao_hero_mobile',
  ...
  return (
    <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden pt-14">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div 
          className="absolute inset-0 w-full h-full bg-gradient-to-br from-orange-900 via-red-800 to-black transition-opacity duration-2000 ease-out"
          ...
          <div className="space-y-6 text-center max-w-sm w-full">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl font-bold leading-tight drop-shadow-lg">
                <span className="text-white block">Alegria e cor...</span>
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
                ...
                >
                  ...
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-orange-400 to-red-600 flex items-center justify-center shadow-lg group-hover:shadow-orange-400/50 transition-all group-hover:scale-110">
                    <Play className="w-3 h-3 text-black fill-current ml-0.5" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xs font-bold">Ver Nossa Expertise</span>
                    <span className="text-xs text-orange-200/80">Especialistas em Shows</span>
                  </div>
                </Button>
              </div>
